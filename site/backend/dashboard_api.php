...
try {
    ...
    // CORREÇÃO: Adicionado filtro de status ativo para dirigentes
    ...
    // CORREÇÃO: Filtro para mostrar apenas mapas em uso (com dirigente)
    ...
    // CORREÇÃO: Buscando o campo correto 'pessoas_faladas_total'
