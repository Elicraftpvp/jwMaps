...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('salvar-mapa-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            mapaModal.hide();
            carregarMapas();
        } catch (error) { alert('Erro ao salvar o mapa.'); }
    });
    ...
    tableBody.addEventListener('click', async (e) => {
        ...
        // --- CORREÇÃO ESTÁ AQUI ---
            ...
            await carregarDirigentesNoModal(); // A palavra-chave 'await' garante que a lista carregue antes de mostrar
            entregarModal.show(); // <<< ESTA LINHA ESTAVA FALTANDO
        } 
